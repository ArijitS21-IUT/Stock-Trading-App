        ...
        <div className='container'>
            ...
            <div className='row fs-6' style={{paddingBottom:'6rem',lineHeight:'1.8',fontSize:'1.2rem'}}>
                <div className='col-6 text-center'>
                    <img src='media/ArijitSengupta.jpg' alt='education1' style={{width:'60%', borderRadius:"50%"}}/>
                    <h4 className='mt-3'>Arijit Sengupta</h4>
                    <h5 className='fs-6'>Software Engineer</h5>
                </div>
                <div className='col'>
                    ...
                    <p>Connect on <a href='https://github.com/ArijitS21-IUT'>Github</a> / <a href='https://www.linkedin.com/in/arijitsengupta2003'>LinkedIn</a> </p>
                </div>
            </div>
        </div>     
     );
